...
// Page AutoConnectCoreImpl text: in progress...
#ifndef AUTOCONNECT_TEXT_RESETINPROGRESS
#define AUTOCONNECT_TEXT_RESETINPROGRESS " in progress..."
#endif // !AUTOCONNECT_TEXT_RESETINPROGRESS
