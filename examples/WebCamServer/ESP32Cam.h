...
class ESP32Cam {
 public:
  ...
  esp_err_t oneShot(fs::SDMMCFS& sdmmc, const char* filename = nullptr);
  esp_err_t timerShot(const unsigned long period, fs::SDFS& sd, const char* filenamePrefix = nullptr);
  esp_err_t timerShot(const unsigned long period, fs::SDMMCFS& sdmmc, const char* filenamePrefix = nullptr);
 ...
 private:
  ...
  // The pin assignment for wiring to the sensor is static.
  static const _pinsAssign_t _pinsMap[];
};
